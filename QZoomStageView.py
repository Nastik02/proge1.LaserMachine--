...
class QZoomStageView(QWidget):
    ...
    def setMarkerState(self):
        if self.__markerState == MarkerState.OFF or self.__markerState == MarkerState.HIDE:
            self.__markerState = MarkerState.ON
        else:
            self.__markerState = MarkerState.OFF
        print("kk")
        self.update()
    ...
    def paintEvent(self, e: QPaintEvent):
        ...
        painter.drawStaticText(QPointF(5, 50), QStaticText(f"State: {str(self.__markerState)}"))
